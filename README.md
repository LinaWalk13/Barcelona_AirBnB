...
| **Ownership Structure**      | 2018, 2025                       | Share of legal entities, individuals, and homeowners in cadastral records.                                            |
...
* **Modeling**: Bayesian linear regression models (via `brms`) with interaction terms between time and Airbnb density, as well as random effects for census sections.
