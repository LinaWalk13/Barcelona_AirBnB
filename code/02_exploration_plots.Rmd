...
listings <- readRDS("../data/processed/listings_sf.rds")
before <- readRDS("../data/processed/census_analysis_before.rds")
after  <- readRDS("../data/processed/census_analysis_after.rds")
combined <- readRDS("../data/processed/merged_data_delta.rds")
